...
namespace Dythervin.ObjectPool.Component
{
        ...
        where T : UnityEngine.Component
    {
        ...
        T Get(Transform parent, in Vector3 position, in Quaternion rotation, bool setActive = true, Space space = Space.World);
        T Get(in Vector3 position, bool setActive = true);
        T Get(Transform parent, in Vector3 position, bool setActive = true, Space space = Space.World);
    }
}